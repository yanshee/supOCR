        ...
        <div>
            ...
            <div className="button-container">
                ...
                {/* <a className="button" href='/AlertReturns'> Return Alerts</a> */}
                    ...
                    {/* <select class='button' value={this.state.selectedOption}>
                        <option selected onClick={() => navigate("/AlertRR")} onSelect={e => navigate("/AlertRR")}>Retailer Return Alert</option>
                        <option selected onClick={() => navigate("/AlertCR")} onSelect={e => navigate("/AlertCR")}>Customer Return Alert</option>
                    </select> */}
                    <select className="button" onChange={handleSelectChange}>
