...
function RetailerReturnProcessReturnConfirm()
{
    ...
    return (
        <div>
            ...
            <br/>
            <button className='CC-ConfirmBtn' onClick={() => navigate("/RetailerReturnItemListing")} >Continue</button>
        </div>
    )
}

export default RetailerReturnProcessReturnConfirm